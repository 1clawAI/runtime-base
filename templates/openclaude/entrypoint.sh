...
echo "1claw runtime-openclaude starting (runtime_id=${ONECLAW_RUNTIME_ID:-unknown}, agent_id=${ONECLAW_AGENT_ID:-unknown})"

cd /app/workspace

USER_PORT="${USER_PORT:-8000}"
PUBLIC_PORT="${PORT:-8080}"
export ONECLAW_FRAMEWORK="${ONECLAW_FRAMEWORK:-openclaude}"
export USER_PORT
