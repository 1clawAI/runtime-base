...
echo "1claw runtime-codex starting (runtime_id=${ONECLAW_RUNTIME_ID:-unknown}, agent_id=${ONECLAW_AGENT_ID:-unknown})"

cd /app/workspace

USER_PORT="${USER_PORT:-8000}"
PUBLIC_PORT="${PORT:-8080}"
export ONECLAW_FRAMEWORK="${ONECLAW_FRAMEWORK:-codex}"
export USER_PORT
export CODEX_CONFIG_DIR="${CODEX_CONFIG_DIR:-/app/workspace/.codex}"
