...
echo "1claw runtime-amp starting (runtime_id=${ONECLAW_RUNTIME_ID:-unknown}, agent_id=${ONECLAW_AGENT_ID:-unknown})"

cd /app/workspace

USER_PORT="${USER_PORT:-8000}"
PUBLIC_PORT="${PORT:-8080}"
export ONECLAW_FRAMEWORK="${ONECLAW_FRAMEWORK:-amp}"
export USER_PORT
export AMP_CONFIG_DIR="${AMP_CONFIG_DIR:-/app/workspace/.amp}"
